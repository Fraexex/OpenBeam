...
function [output_signal] = MAX2821(input_signal, sampling_rate)
    % Input parameters:
    ...
    IF_BANDWIDTH = 4e6;   % IF bandwidth

    LO_FREQ = 2.45e9 - IF_BANDWIDTH;      % Local oscillator frequency (center of band)
    ...
    [b, a] = butter(6, IF_BANDWIDTH/(sampling_rate/2), 'high');
